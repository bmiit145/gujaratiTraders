            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 px-0 mx-auto">
                    ...
                    <form action="{{ route('stripe.checkout')}}" method="get"> 
                        <div class="card">
                            <h4 class="p-3 text-bg-success" style="font-family: gujFont2;">Cart Total</h4>
                            ...
                            <div class="row pt-0 pb-3 px-3 d-flex align-items-center">
                                ...
                                <div class="col-8 fs-5">
                                    <div class="input-group border" style="border-radius: 7px">
                                        <input type="text" placeholder="coupon code" class="form-control coupen border" id="cupan_code">
                                        <a class="btn btn-success cupan_code" style="font-family: gujFont2">
                                            application do</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button class="btn btn-success px-5 py-2 ms-auto fs-5"  style="font-family: gujFont2;">
                                Buy now</button>
                        </div>
                    </form>
                </div>

                                ...
                                <table id="datatable" class="">
                                    ...
                                    <thead class="text-black">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-nowrap">Total Registered Users</th>

                                            <th class="text-nowrap">Event Registered Limit</th>
                                        ...
                                        @foreach ($events as $event)
                                            ...
                                            @if ($event->is_delete == 1)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $event->total_registered_users }}</td>

                                                    <td>{{ $event->event_registered_limit }}</td>

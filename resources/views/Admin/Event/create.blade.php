                            ...
                            <div class="container-fluid">
                                ...
                                <form class="row" action="{{ route('admin.store_upcoming_event') }}" method="POST">
                                    ...
                                    <div class="mb-3 col-xl-6 col-lg-6 col-md-6">
                                        ...
                                        <label for="exampleInputPassword1" class="form-label">Event Registered Limit</label>

                                        <input type="text" class="form-control" value="{{ old('event_registered_limit') }}"

                                            name="event_registered_limit" placeholder="Enter Event Registered Limit">

                                        @error('event_registered_limit')

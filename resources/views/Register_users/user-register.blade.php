@extends('header-footer')@section('content')
...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/jquery-countryselector/1.0.0/jquery.countryselector.min.css" rel="stylesheet"> 
    ...
    <style>
        ...
        .guj-label-register {
            ...
            font-family: gujFont2 !important;
            font-size: 20px;
        }
...
<body class="bg-light">
    ...
    <div class="col-12" style="margin-top: 100px;margin-bottom:100px">
        ...
        <form action="{{ route('store.course.register.user') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <label for="" class="guj-label-register pt-3">5}Ú\ GFD</label>
                        ...
                        <!-- {{-- <label for="country" class="form-label guj-label-register mt-3 mb-0">N[X 5;\N SZM</label>
                        ...
                        <label class="form-label guj-label-register mt-3 mb-0">N[X 5;\N SZM</label>

                        <select name="country" id="country" class="w-100 p-2 border">
                            <option value="">-- Choose Country --</option>
                        ...
                        <label for="" class="guj-label-register mt-3">X[ZLG] ;ZGFD]\</label>
                        ...
                        <label for="" class="guj-label-register mt-3">GUZíXC[Z</label>
                        ...
                        <div class="d-xl-flex d-lg-flex d-md-flex d-sm-none d-none align-items-center mt-3">
                            ...
                            <label class="guj-label-register mb-0"><a href="{{ route('term_and_condition') }}">lGIDM VG[
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
            ...
            <label for="state" class="form-label guj-label-register mt-3 mb-0">ZFþI 5;\N SZM</label>
            ...
            <label for="" class="guj-label-register mt-3">85F,G\AZíhL5</label>
            ...
            <div class="col-12">
                ...
                <label for="phone" class="form-label guj-label-register mt-3 mb-0">OMG G\AZ</label><br>
            ...
            <label for="" class="guj-label-register mt-3">> < D[>,</label>
    ...
    <div class="d-flex justify-content-center mt-5">
        ...
        <button type="submit" class="btn btn-success w-auto px-5 guj-label-register">;AlD8 SZM</button>

    </div>

<div class="text-center pt-2">

    <a href="" style="font-family: gujFont2;text-decoration: none;color:#000">TD[ •[ 5[C,[YL Z_:8Z KM TM m</a>

    <a href="{{url('alredy_register_dfghuifh')}}" style="font-family: gujFont2">VCš ˜S®,S SZM</a>
        ...
        $(document).ready(function() {
            ...
            $('#country').on('change', function() {
                ...
                if (selectedCountry === 'other') {
                    ...
                    if (newCountry) {
                        $('#country').append('<option value="' + newCountry.toLowerCase() + '">' + newCountry + '</option>');
                        $('#country').val(newCountry.toLowerCase()).trigger('change');
                    }
                }
            });
        });
